  ...
  >
    ...
    <template v-slot:[`item.actions`]="{ item }">
      ...
      <v-btn
        ...
        small
        v-if="item.estado !== 'Activo'"
        @click="cambiarestado('Activo', item.idcategoria)"
        x-small
        dark
      >
        Activar
...
export default {
  ...
  methods: {
    ...
    cambiarestado(estado, idcategoria) {
      axios
        .put(
          `${this.$store.state.urlapi}/categorias/${idcategoria}`,
          { estado: estado },
          this.getTokenUser
        )
        .then(() => {
    ...
    postItem() {
      axios
        .post(
          `${this.$store.state.urlapi}/categorias/`,
          this.editedItem,
          this.getTokenUser
        )
        .then(() => {
    ...
    putItem() {
      ...
      axios
        .put(
          `${this.$store.state.urlapi}/categorias/${this.editedItem.idcategoria}`,
          formData,
          this.getTokenUser
        )
        .then(() => {
